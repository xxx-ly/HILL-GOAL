    ...
    function f(e, o, t) {
      ...
      if ("undefined" != typeof document) {
        if (1 < arguments.length) {
          switch (
            typeof (t = c.extend({ path: pum_vars.home_url }, f.defaults, t))
              .expires
          ) {
            case "number":
        ...
        for (
          ...
          try {
            var u = p[0].replace(s, decodeURIComponent),
              l = d.read
                ? d.read(l, u)
                : d(l, u) || l.replace(s, decodeURIComponent);
            if (this.json)
              try {
                l = JSON.parse(l);
              } catch (e) {}
    ...
    c.extend(c.fn.popmake, {
      cookie:
        ...
        (f.remove = function (e, o) {
          f(e, "", c.extend({}, o, { expires: -1, path: "" })),
            f(e, "", c.extend({}, o, { expires: -1 }));
        }),
...
!(function (s, e) {
  ...
  (function (t) {
    ...
    (i.m = t),
      ...
      (i.p = ""),
      i((i.s = "./assets/js/src/integration/wsforms.js"));
  })({
